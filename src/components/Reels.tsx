      ...
      <div ref={containerRef} className="snap-y snap-mandatory h-screen overflow-y-auto overscroll-y-contain scroll-smooth">
        {posts.map((post, index) => {
          ...
          return (
            ...
            >
              <div className="w-full max-w-[420px] h-[calc(100vh-16px)] relative flex items-center justify-center mx-auto overflow-hidden">
              {(() => {
              ...
              <div className="absolute bottom-20 right-3 flex flex-col items-center space-y-5 z-10 bg-black/25 dark:bg-black/20 rounded-2xl px-2 py-3 backdrop-blur-sm">
                ...
                <button onClick={(e) => handleMoreClick(post, e)} className="flex flex-col items-center">
