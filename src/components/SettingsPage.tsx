  ...
  return (
    <div className="p-6 md:p-8 max-w-4xl text-gray-900 dark:text-gray-100 space-y-8">
      ...
      <section className="rounded-xl border p-4 space-y-3">
        ...
        <button
          className="mt-2 w-full px-4 py-2 rounded-md bg-indigo-600 text-white"
          onClick={() => {
            window.history.pushState({}, '', '/native-test');
      ...
      <section className="rounded-xl border p-4 space-y-3">
        <h2 className="font-semibold">6) Native 테스트 (TEMP)</h2>
        <p className="text-sm text-gray-600 dark:text-gray-300">GPS / Bluetooth / Push 테스트 페이지로 이동합니다.</p>
        <button
