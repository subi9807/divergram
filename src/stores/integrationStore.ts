...
const hasCloudinaryConfig = Boolean(process.env.EXPO_PUBLIC_CLOUDINARY_CLOUD_NAME || process.env.CLOUDINARY_CLOUD_NAME);
...
const defaultIntegrations: UserIntegration[] = [
  ...
  { id: 'it-cloudinary', userId: 'me', type: 'cloudinary', connected: hasCloudinaryConfig, statusMessage: hasCloudinaryConfig ? '활성' : '설정 필요', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
