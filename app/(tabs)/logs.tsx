                ...
                <View key={field.key} className="w-1/2 p-1">
                  <View className="rounded-2xl border border-surface-200 bg-white p-3">
                    <View className="mb-2 flex-row items-center">
                      ...
                      <Text className="ml-1 text-xs font-semibold text-surface-500">{t(field.labelKey)}</Text>
                    </View>
                    <View className="flex-row items-center">
                      <TextInput
                      ...
                      />
                      {'suffix' in field && <Text className="ml-1 text-sm text-surface-500">{field.suffix}</Text>}
                      {'suffixKey' in field && <Text className="ml-1 text-sm text-surface-500">{t(field.suffixKey)}</Text>}
                    </View>
                  </View>
                </View>
              );
