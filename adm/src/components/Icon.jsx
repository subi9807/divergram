export default function Icon({ kind }) {
  ...
  if (kind === 'facilities') return <svg {...common}><rect x="4" y="5" width="16" height="14" rx="2"/><path d="M8 5v14"/><path d="M4 11h16"/><path d="M12 5v14"/></svg>;
  ...
  if (kind === 'ads') return <svg {...common}><path d="M3 11h4l7-5v12l-7-5H3z"/><path d="M14 8c1.5 1 2 2.5 2 4s-.5 3-2 4"/><path d="M17 5c2.5 1.5 4 4 4 7s-1.5 5.5-4 7"/></svg>;
  if (kind === 'pricing') return <svg {...common}><path d="M7 7h10a2 2 0 0 1 2 2v3H5V9a2 2 0 0 1 2-2z"/><path d="M5 12v5a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-5"/><path d="M9 7V5a3 3 0 0 1 6 0v2"/><path d="M9 16h6"/></svg>;
  if (kind === 'push') return <svg {...common}><path d="M15 17H9l-3 3v-3H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-1z"/><path d="M8 9h8"/><path d="M8 12h5"/></svg>;
  if (kind === 'reports') return <svg {...common}><path d="M7 3h10l4 4v10a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z"/><path d="M14 3v5h5"/><path d="M8 12h8"/><path d="M8 16h5"/></svg>;
  ...
  if (kind === 'settings' || kind === 'profile') return <svg {...common}><path d="M20 21a8 8 0 0 0-16 0"/><circle cx="12" cy="8" r="4"/></svg>;
