...
const DATA_TABLES = {
  profiles: { table: 'app_profiles', columns: ['id','username','full_name','bio','avatar_url','website','account_type','scuba_level','freediving_level','license_image_url','license_type','license_number','license_agency','license_issued_at','resort_address','resort_region','resort_lat','resort_lng','resort_rating_avg','resort_review_count','created_at'] },
