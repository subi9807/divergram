...
CREATE POLICY "Users can view stories from followed users" ON stories
  FOR SELECT TO authenticated
  USING (true);
...
DROP POLICY IF EXISTS "Anyone can view highlights" ON story_highlights;
DROP POLICY IF EXISTS "Users can manage own highlights" ON story_highlights;

CREATE POLICY "Anyone can view highlights" ON story_highlights
  FOR SELECT TO authenticated
  USING (true);

CREATE POLICY "Users can manage own highlights" ON story_highlights
...
CREATE POLICY "Users can manage own highlight stories" ON highlight_stories
  FOR ALL TO authenticated
  USING (
    EXISTS (
