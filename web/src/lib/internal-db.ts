...
const API_BASE = import.meta.env.VITE_API_BASE_URL || (typeof window !== 'undefined' ? window.location.origin : 'https://app.divergram.com');
...
export interface Post {
  ...
  dive_duration?: number; dive_site?: string; visibility?: number; gas_type?: 'air' | 'nitrox' | 'heliox'; gas_percent?: number; buddy?: string; buddy_name?: string; location?: string; publish_to_feed?: boolean; publish_to_reels?: boolean;
}
