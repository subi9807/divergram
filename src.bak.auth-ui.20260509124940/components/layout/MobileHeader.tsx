...
export default function MobileHeader({ currentPage, mobileBarsHidden, onNavigate, onToggleMenu }: MobileHeaderProps) {
  return (
    <header className={`dg-mobile-header fixed top-0 left-0 right-0 xl:hidden bg-white dark:bg-[#1b1d21] border-b border-gray-300 dark:border-[#2f333a] z-50 transition-transform duration-300 ease-out transition-colors ${mobileBarsHidden ? '-translate-y-full' : 'translate-y-0'}`}>
