...
export default function MobileFooterNav({ currentPage, mobileBarsHidden, onNavigate, profileAvatarUrl }: MobileFooterNavProps) {
  ...
  return (
    ...
    >
      <nav className="mx-auto mb-2 w-[calc(100%-14px)] max-w-sm rounded-[30px] border border-gray-200/80 bg-white/95 px-2 py-2 shadow-[0_12px_30px_rgba(15,23,42,0.12)] backdrop-blur-md dark:border-[#2a2e35] dark:bg-[#17191d]/95 dark:shadow-none">
